	...
	protected function getForm() {
		...
		foreach ($oct_banner_plus_images as $oct_banner_plus_image) {
			...
			$data['oct_banner_plus_images'][] = [
		        ...
		        'background_color'   => $oct_banner_plus_image['background_color'] ? $oct_banner_plus_image['background_color'] : 'rgb(53, 62, 72)',
				'title_color'        => $oct_banner_plus_image['title_color'] ? $oct_banner_plus_image['title_color'] : 'rgb(222, 222, 222)',
		        'text_color'         => $oct_banner_plus_image['text_color'] ? $oct_banner_plus_image['text_color'] : 'rgb(222, 222, 222)',
		        'button_color'       => $oct_banner_plus_image['button_color'] ? $oct_banner_plus_image['button_color'] : 'rgb(255, 255, 255)',
		        'button_background'  => $oct_banner_plus_image['button_background'] ? $oct_banner_plus_image['button_background'] : 'rgb(102, 102, 102)',
		        'button_background_hover'  => $oct_banner_plus_image['button_background_hover'] ? $oct_banner_plus_image['button_background_hover'] : 'rgb(166, 166, 166)',
		        'button_text_hover'  => $oct_banner_plus_image['button_text_hover'] ? $oct_banner_plus_image['button_text_hover'] : 'rgb(255, 255, 255)',
