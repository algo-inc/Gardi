...
class ModelOCTemplatesBlogOCTBlogArticle extends Model {
	...
	public function getArticles($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "oct_blogarticle a LEFT JOIN " . DB_PREFIX . "oct_blogarticle_description ad ON (a.blogarticle_id = ad.blogarticle_id) WHERE ad.language_id = '" . (int)$this->config->get('config_language_id') . "'";
