		                            ...
		                            if ($result['sub_categories']) {
		                                ...
		                                foreach ($category_children as $child) {
											...
											if ($child['image'] && is_file(DIR_IMAGE . $child['image'])) {
												$child_category_image = $this->model_tool_image->resize($child['image'], $result['img_width'], $result['img_height']);
											} else {
												$child_category_image = $this->model_tool_image->resize('no-thumb.png', $result['img_width'], $result['img_height']);
											}
