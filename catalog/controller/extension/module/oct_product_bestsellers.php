...
class ControllerExtensionModuleOctProductBestsellers extends Controller {
    public function index($setting) {
        ...
        $data['oct_lazy_image'] = $this->config->get('theme_oct_ultrastore_lazyload_image') ? $this->model_tool_image->resize($this->config->get('theme_oct_ultrastore_lazyload_image'), 30, 30) : 'catalog/1lazy/lazy-image.svg';
        ...
        foreach ($products as $product_info) {
                ...
                $data['products'][] = [
                    ...
                    'oct_model'	  => $this->config->get('theme_oct_ultrastore_data_model') ? $product_info['model'] : '',
