		...
		if (!$oct_popup_purchase_info) {
	        ...
	        $this->model_setting_setting->editSetting('oct_popup_purchase', [
	            ...
	            'oct_popup_purchase_data' => [
	                ...
	                'image' => '1',
	                'image_width' => $this->config->get('theme_oct_ultrastore_image_thumb_width'),
	                'image_height' => $this->config->get('theme_oct_ultrastore_image_thumb_height'),
