...
class ControllerOctemplatesModuleOctStockNotifier extends Controller {
    ...
    public function addEvent() {
        ...
        if ($this->model_setting_event->getEventByCode('octemplates-ultrastore-stock-notifier')) {
            return;
        }
        ...
        $events = [
            [
                'code' => 'octemplates-ultrastore-stock-notifier',
	...
	public function deleteEvent() {
        ...
        $eventCodes = [
            'octemplates-ultrastore-stock-notifier'
        ];
