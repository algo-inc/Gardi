...
class ControllerExtensionThemeOCTUltrastore extends Controller {
	...
	public function update() {
		...
		$permissions = [
			'octemplates/blog/oct_blogsettings',
			'octemplates/stickers/oct_stickers_settings',
			'octemplates/module/oct_information_bar',
			'extension/module/oct_benefits',
		...
		$filesToDelete = [
			DIR_APPLICATION.'controller/octemplates/stickers/oct_stickers.php',
			DIR_APPLICATION.'model/octemplates/stickers/oct_stickers_settings.php',
			DIR_APPLICATION.'model/octemplates/stickers/oct_stickers.php',
			DIR_APPLICATION.'view/template/octemplates/stickers/oct_stickers_list.twig',
			DIR_APPLICATION.'view/template/octemplates/stickers/oct_stickers_form.twig',
			DIR_SYSTEM.'oct_categories_quantity.ocmod.xml',
			DIR_SYSTEM.'oct_ultrastore_manufacturer_description_OCStore.ocmod.xml',
			DIR_SYSTEM.'oct_ultrastore_noindex_OCStore.ocmod.xml',
			DIR_APPLICATION.'controller/extension/module/oct_shop_advantages.php',
			DIR_APPLICATION.'language/en-gb/extension/module/oct_shop_advantages.php',
			DIR_APPLICATION.'language/ru-ru/extension/module/oct_shop_advantages.php',
			DIR_APPLICATION.'language/uk-ua/extension/module/oct_shop_advantages.php',
			DIR_APPLICATION.'language/en-gb/octemplates/module/oct_shop_advantages.php',
			DIR_APPLICATION.'language/ru-ru/octemplates/module/oct_shop_advantages.php',
			DIR_APPLICATION.'language/uk-ua/octemplates/module/oct_shop_advantages.php',
			DIR_APPLICATION.'view/template/octemplates/module/oct_shop_advantages.twig',
			DIR_CATALOG.'controller/extension/module/oct_shop_advantages.php',
			DIR_CATALOG.'view/theme/oct_ultrastore/template/octemplates/module/oct_shop_advantages.twig'
		];
	...
	public function octSettings() {
		return [
			...
			'theme_oct_ultrastore_seo_home_status',
			'theme_oct_ultrastore_seo_home_data',
			'theme_oct_ultrastore_seo_home_image_status',
			'theme_oct_ultrastore_seo_home_image_data',
		];
	}
	...
	public function install() {
		...
		$this->model_setting_setting->editSetting('theme_oct_ultrastore', [
			...
			'theme_oct_ultrastore_seo_home_status' => 0,
			'theme_oct_ultrastore_seo_home_data' => [
				'title' => '',
				'description' => ''
			],
			'theme_oct_ultrastore_seo_home_image_status' => 0,
			'theme_oct_ultrastore_seo_home_image_data' => [
				'image' => ''
			],
		]);
